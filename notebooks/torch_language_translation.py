...
from notebooks.language_translation.model import Translator # Our model
from notebooks.language_translation.data import get_data, create_mask, generate_square_subsequent_mask # Loading data and data preprocessing
