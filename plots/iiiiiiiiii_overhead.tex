...
\begin{figure}[t]
    ...
    \end{tikzpicture}
    \vspace{-6mm}
    \caption{\fix{\pga's access control overhead. Error bars show the two standard deviation of time measurements. Percentages refer relative overheads over the baseline.}}
